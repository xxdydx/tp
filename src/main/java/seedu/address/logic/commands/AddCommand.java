...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_WEDDING_DATE_REQUIRED_FOR_CLIENT =
            "Wedding date is required when type is CLIENT.";
    public static final String MESSAGE_WEDDING_DATE_FORBIDDEN_FOR_VENDOR =
            "Wedding date must be empty when type is VENDOR.";
