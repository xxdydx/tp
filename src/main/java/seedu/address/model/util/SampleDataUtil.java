    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                    ...
                    WeddingDate.parse("15-06-2020"), PersonType.CLIENT, getCategorySet(), null,
                    new Budget("5000-10000"), Optional.of(new Partner("Cierra Wang"))),
            new Person(new Name("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
                    new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                    WeddingDate.parse("22-03-2019"), PersonType.CLIENT, getCategorySet(), null,
                    new Budget("8000-15000"), Optional.of(new Partner("Jackson Wang"))),
            new Person(new Name("Charlotte Oliveiro"), new Phone("93210283"), new Email("charlotte@example.com"),
                    new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                    WeddingDate.parse("10-12-2021"), PersonType.VENDOR, getCategorySet("Photography & Videography"),
                    new Price("500-1000"), null, Optional.empty()),
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    WeddingDate.parse("05-08-2018"), PersonType.CLIENT, getCategorySet(), null,
                    new Budget("3000-6000"), Optional.of(new Partner("Jia Min"))),
            new Person(new Name("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                    new Address("Blk 47 Tampines Street 20, #17-35"),
                    WeddingDate.parse("18-11-2022"), PersonType.CLIENT, getCategorySet(), null,
                    new Budget("10000-15000"), Optional.of(new Partner("Siti Nur"))),
            new Person(new Name("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                    new Address("Blk 45 Aljunied Street 85, #11-31"),
                    WeddingDate.parse("25-09-2020"), PersonType.VENDOR, getCategorySet("Wedding Planning & Events"),
