...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, VALID_TYPE, null, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidWeddingDate_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        INVALID_WEDDING_DATE, VALID_TYPE, null, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullWeddingDate_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, null,
                VALID_TYPE, null, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, VALID_TYPE, null, null, VALID_REMARK, invalidTags);
    ...
    public void toModelType_invalidType_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, INVALID_TYPE, null, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullType_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, null, null, null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidPrice_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, VALID_TYPE, "invalid-price", null, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidBudget_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_WEDDING_DATE, VALID_TYPE, null, "invalid-budget", VALID_REMARK, VALID_TAGS);
